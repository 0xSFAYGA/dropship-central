...
## 🎯 PROMPT STRUCTURE RULES (FOR GEMINI)
...
PROVIDES: [What it exports/returns]

ARCHITECTURE CONTEXT: [Where it fits in the big picture]
...
[Detailed requirements and code patterns]
...
☑ Git initialized with main, staging, develop branches
☑ GitHub repository created and linked
☑ Project structure created (backend/app/, etc)
☑ GEMINI.md in project root
☑ ARCHITECTURE.md in docs/
☑ Step-by-step prompts in docs/prompts/
...
☑ Plugin system pattern understood
☑ Step-by-step roadmap printed
☑ Code quality rules internalized
☑ Prompt structure rules understood
...
☑ Ready to generate STEP 1: config.py
```
...
2. **Understand the architecture** - See how pieces connect
3. **Review the database schema** - Know what gets stored
4. **Study the plugin system** - See how to extend
5. **Open docs/prompts/STEP-1-CONFIG.md**
6. **Copy the prompt**
7. **Open Gemini CLI: `gemini`**
8. **Paste the prompt**
9. **Get code, save to backend/app/config.py**
10. **Commit and push**
11. **Repeat for each step**
